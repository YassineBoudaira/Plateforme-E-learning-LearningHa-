...
$req = $bd->prepare("INSERT INTO notes (title, description, text, date_note , profile_id, course_id) values(?,?,?,?,?,?)");
$req->execute([$titre, $description, $text, $date, $profile_id, $cours_id]);
  // echo '<pre>';
  // var_dump($req);
  // echo '</pre>';
  // die();
                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input  type="date" name="date_note" id="date_note" class="form-control" placeholder=""
